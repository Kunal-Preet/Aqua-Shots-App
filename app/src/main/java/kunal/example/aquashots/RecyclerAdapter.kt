...
class RecyclerAdapter(private val dataSet: MutableList<UserInfo>) :
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        val textDetails: TextView = view.findViewById(R.id.textViewInfo)
    ...
    override fun onBindViewHolder(viewHolder: ViewHolder, position: Int) {
        ...
        viewHolder.textDetails.text = dataSet[position].toString()
    }
